...
def main(unused_argv):
    ...
    if(FLAGS.importextadj):
        ...
        train_attr_matrix = sp.csr_matrix(np.load('train_adj&train_attrcora_ml.npz')['train_attr_matrix'][smth['train_labels']])
        train_labels = (np.load('train_adj&train_attrcora_ml.npz')['train_labels'])[smth['train_labels']]
